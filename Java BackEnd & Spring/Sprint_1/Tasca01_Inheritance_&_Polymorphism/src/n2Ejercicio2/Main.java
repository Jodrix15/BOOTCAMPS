...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * consola un missatge dient que s’està trucant al número rebut per paràmetre. 
			Crea una interfície anomenada "Camera" amb el mètode fotografiar(), i una altra interfície 
			anomenada Rellotge amb el mètode alarma().
		...
		Smartphone sPhone = new Smartphone("apple", "i5");
		
		sPhone.llamar(666777888);
		sPhone.alarma();
		sPhone.hacerFoto();
